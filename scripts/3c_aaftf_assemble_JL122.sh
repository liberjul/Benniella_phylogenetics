...
#SBATCH --job-name=assemble_ben_reads_JL122        # you can give your job a name for easier identification (same as -J)
...
do
  ...
  if [ $(echo $i | cut -d'/' -f1) == "BenspLightDraft_2_FD_JL122" ]
  then
