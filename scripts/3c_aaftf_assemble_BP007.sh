...
#SBATCH --job-name=assemble_Actsp_reads_BP007        # you can give your job a name for easier identification (same as -J)
...
do
  ...
  if [ $(echo $i | cut -d'/' -f1) == "ActspLightDraft_4_FD_BP007" ]
  then
